...
class ApplicationViews extends Component {
  ...
  async componentDidMount() {
    ...
    await  ProjectHandler.getAll()
      ...
      .then(gitRepos => newState.gitRepos = gitRepos)
        ...
        <div>
          ...
          <Route
            ...
            render={props => {
              ...
              let projectTask = "";
              if (this.isAuthenticated()) {
                projectTask = this.state.tasks.filter(
                  task => task.projectName === props.match.params.projectName
                );
                return (
                  <Task
                    {...props}
